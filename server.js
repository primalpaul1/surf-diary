...
app.get('/.well-known/apple-app-site-association',(req,res)=>{const aasa=fs.readFileSync(path.join(__dirname,'public','.well-known','apple-app-site-association'));res.type('application/json').send(aasa);});
